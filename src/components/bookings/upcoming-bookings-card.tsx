...
import { Bell, Calendar, Clock, MapPin, Loader2 } from 'lucide-react'
...
export function UpcomingBookingsCard({ userId }: { userId: string }) {
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Booking dalam 24 jam ke depan</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <div className="space-y-3">
          {bookings.map((booking) => (
            ...
            >
              ...
              <Link href={`/bookings/${booking.id}`} className="mt-3 block">
